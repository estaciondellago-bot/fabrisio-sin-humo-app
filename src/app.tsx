...
function ToolIllustration({illustrationId,isLocked}: {illustrationId: string; isLocked?: boolean}) {
  ...
  const svgs = {
    ...
    'swot-analysis':(<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg" className="w-full h-full"><defs><linearGradient id="sw-active" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor={gold} stopOpacity="0.4"/><stop offset="100%" stopColor={gold} stopOpacity="0.12"/></linearGradient></defs><rect x="33" y="13" width="134" height="74" rx="6" fill="none" stroke={gold} strokeWidth="0.8" opacity="0.3"/><rect x="38" y="18" width="58" height="30" fill="url(#sw-active)" rx="2.5"/><rect x="38" y="18" width="58" height="30" fill="none" stroke={gold} strokeWidth="1.2" opacity="0.75" rx="2.5"/><text x="48" y="36" fontSize="11" fontWeight="bold" fill={gold}>F</text><circle cx="88" cy="26" r="1.6" fill={gold}/><rect x="104" y="18" width="58" height="30" fill={gold} opacity="0.07" rx="2.5"/><rect x="104" y="18" width="58" height="30" fill="none" stroke={gold} strokeWidth="0.8" opacity="0.4" rx="2.5"/><text x="114" y="36" fontSize="11" fontWeight="bold" fill={gold} opacity="0.55">O</text><rect x="38" y="52" width="58" height="30" fill={gold} opacity="0.07" rx="2.5"/><rect x="38" y="52" width="58" height="30" fill="none" stroke={gold} strokeWidth="0.8" opacity="0.4" rx="2.5"/><text x="48" y="70" fontSize="11" fontWeight="bold" fill={gold} opacity="0.55">D</text><rect x="104" y="52" width="58" height="30" fill="url(#sw-active)" rx="2.5"/><rect x="104" y="52" width="58" height="30" fill="none" stroke={gold} strokeWidth="1.2" opacity="0.75" rx="2.5"/><text x="114" y="70" fontSize="11" fontWeight="bold" fill={gold}>A</text><circle cx="154" cy="60" r="1.6" fill={gold}/></svg>),
    'brand-story':(<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg" className="w-full h-full"><defs><linearGradient id="bs-line" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stopColor={gold} stopOpacity="0.55"/><stop offset="50%" stopColor={gold} stopOpacity="1"/><stop offset="100%" stopColor={gold} stopOpacity="0.55"/></linearGradient><filter id="bs-glow" x="-50%" y="-50%" width="200%" height="200%"><feGaussianBlur stdDeviation="2.5"/></filter></defs><line x1="20" y1="82" x2="180" y2="82" stroke={gold} strokeWidth="0.4" opacity="0.2" strokeDasharray="2 3"/><path d="M30 50 Q 60 22, 100 50 T 170 50" stroke={gold} strokeWidth="6" fill="none" opacity="0.18" filter="url(#bs-glow)"/><path d="M30 50 Q 60 22, 100 50 T 170 50" stroke="url(#bs-line)" strokeWidth="2.5" fill="none" strokeLinecap="round"/><circle cx="30" cy="50" r="11" fill="none" stroke={gold} strokeWidth="0.8" opacity="0.35"/><circle cx="30" cy="50" r="6" fill={gold}/><circle cx="65" cy="32" r="4" fill={dark} stroke={gold} strokeWidth="1.5"/><circle cx="100" cy="50" r="4" fill={dark} stroke={gold} strokeWidth="1.5"/><circle cx="135" cy="68" r="4" fill={dark} stroke={gold} strokeWidth="1.5"/><circle cx="170" cy="50" r="11" fill="none" stroke={gold} strokeWidth="0.8" opacity="0.35"/><circle cx="170" cy="50" r="6" fill={gold}/></svg>),
